        ...
        <form class="w-full max-w-[400px] h-full flex justify-center flex-col gap-[30px] md:pb-20 pb-[50px]">
            ...
            <div class="flex flex-col gap-[25px]">
                ...
                <div class="flex flex-col gap-4">
                        <button type="button" class="bg-[var(--orange)] w-full border border-[var(--orange)] rounded-[4px] text-white text-[18px] text-[16px] text-center py-[8px] ease-out duration-150 hover:bg-white hover:text-[var(--orange)] cursor-pointer" id="backBtn">Previous</button>
