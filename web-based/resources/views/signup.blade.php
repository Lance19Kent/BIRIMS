...
<body class="h-screen max-h-screen w-full relative">
    ...
    <main class="flex-1 w-full relative z-30 md:pl-5 md:flex-row flex-col flex items-center md:gap-0 gap-[30px] md:justify-between" style="height: calc(100vh - 60px); ">
        ...
        <div class="w-full flex justify-center">
            <form class="w-full max-w-[400px] h-full flex justify-center flex-col gap-[30px] md:pb-10 pb-[50px]" method="POST" action="/signup">
    @csrf
                        ...
                        <div class="flex flex-col gap-7">
                            <div class="w-full flex justify-between gap-[30px] md:gap-0">
                                <span class="flex flex-col relative w-full max-w-[190px]">                
                                    ...
                                    <!-- First Name Input -->
                                    <input type="text" name="first_name" maxlength="50" placeholder="ex. Juan" class="peer md:text-[13px] text-[12px] w-full not-first-of-type:duration-150 ease-out h-[40px] border-b focus:outline-none focus:border-b focus:border-[var(--orange)] placeholder:pl-[25px] placeholder-shown:placeholder:opacity-100 focus:placeholder-shown:placeholder:opacity-0 placeholder:text-[var(--darkgray)] overflow-hidden text-ellipsis placeholder:md:text-[14px] placeholder:text-[13px] capitalize">
                                ...
                                <span class="flex flex-col relative w-full max-w-[190px]">                
                                    ...
                                    <input type="text" name="last_name" maxlength="50" placeholder="ex. Dela Cruz" class="peer md:text-[13px] text-[12px] w-full duration-150 ease-out h-[40px] border-b focus:outline-none focus:border-b focus:border-[var(--orange)] placeholder:pl-[25px] placeholder-shown:placeholder:opacity-100 focus:placeholder-shown:placeholder:opacity-0 placeholder:text-[var(--darkgray)] overflow-hidden text-ellipsis placeholder:md:text-[14px] placeholder:text-[13px] capitalize">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-[18px] absolute bottom-[12px] stroke-[var(--darkgray)] opacity-0 peer-placeholder-shown:opacity-100 peer-focus:opacity-0">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 6a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0ZM4.501 20.118a7.5 7.5 0 0 1 14.998 0A17.933 17.933 0 0 1 12 21.75c-2.676 0-5.216-.584-7.499-1.632Z" />
                                    </svg>
                                </span>
                            ...
                            <div class="w-full flex justify-between gap-[30px] md:gap-0">
                                <span class="flex flex-col relative w-full max-w-[190px]">                
                                    ...
                                    <input type="text" name="middle_name" maxlength="50" placeholder="ex. Santos" class="peer md:text-[13px] text-[12px] w-full duration-150 ease-out h-[40px] border-b focus:outline-none focus:border-b focus:border-[var(--orange)] placeholder:pl-[25px] placeholder-shown:placeholder:opacity-100 focus:placeholder-shown:placeholder:opacity-0 placeholder:text-[var(--darkgray)] overflow-hidden text-ellipsis placeholder:md:text-[14px] placeholder:text-[13px] capitalize">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-[18px] absolute bottom-[12px] stroke-[var(--darkgray)] opacity-0 peer-placeholder-shown:opacity-100 peer-focus:opacity-0">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 6a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0ZM4.501 20.118a7.5 7.5 0 0 1 14.998 0A17.933 17.933 0 0 1 12 21.75c-2.676 0-5.216-.584-7.499-1.632Z" />
                                    </svg>
                                </span>
                                <span class="flex flex-col relative w-full max-w-[190px]">                
                                    ...
                                    <input type="date" name="birthdate" id="birthdateInput" class="peer md:text-[13px] text-[12px] text-[var(--darkgray)] w-full duration-150 ease-out h-[40px] border-b  border-black focus:outline-none focus:border-b focus:border-[var(--orange)] cursor-pointer">
                                </span>
                            </div>
                            <div class="w-full flex justify-between gap-[30px] md:gap-0">
                                <span class="flex flex-col relative w-full max-w-[190px]">                
            ...
            <div id="page2" class="hidden md:px-0 px-[30px]">
                ...
                <div class="flex flex-col gap-[25px]">
                    ...
                    <div class="flex flex-col gap-4">
                        ...
                        <button type="submit" class="bg-[var(--orange)] w-full border border-[var(--orange)] rounded-[4px] text-white md:text-[18px] text-[16px] text-center py-[8px] ease-out duration-150 hover:bg-white hover:text-[var(--orange)] cursor-pointer">Create Account</button>
                    </div>  
                </div>
            </div>
            <!--/ Account Credentials Section -->
