...
<body class="min-h-screen max-w-full bg-[#F4F4F5]">
    ...
    <main class="min-h-screen w-full bg-[#F4F4F5] flex-1 flex flex-col">
        ...
        <!-- Steps Section -->
        <section class="min-h-screen w-full bg-white flex flex-col items-center justify-center gap-[30px] pb-[30px] px-[40px] md:px-0 text-center" id="step-section">
            ...
            <div class="w-full px-35 flex md:flex-row flex-col justify-between">
