...
<body class="w-full h-full">
    ...
    <main class="w-full min-h-screen flex-1 bg-[var(--gray)] relative md:pb-[40px] pb-[150px]">
        ...
        <div class="mt-[50px] flex-col flex md:flex-row justify-between gap-[50px] md:pr-[230px] md:pl-[250px]">
            <div class="w-full flex justify-center">
            <div class="w-full md:max-w-[410px] max-w-[300px] h-fit border border-[#71717A] flex flex-col md:sticky md:top-[170px] relative">
                <h1 style="font-family: 'IBM Plex Serif';" class="font-medium text-[16px] md:text-[18px] p-[10px]">On this page</h1>
                <a href="#acceptance-of-terms" class="font-medium text-[16px] md:text-[18px] text-[var(--darkgray)] py-[10px] pl-[10px] duration-150 ease-out hover:bg-[var(--iconorange)] hover:text-[var(--gray100)] active-privacy-nav privacy-nav-links">1. Acceptance of Terms</a>
                <a href="#user-accounts-and-registrations" class="font-medium text-[16px] md:text-[18px] text-[var(--darkgray)] py-[10px] pl-[10px]  duration-150 ease-out hover:bg-[var(--iconorange)] hover:text-[var(--gray100)] privacy-nav-links">2. User Accounts and Registrations</a>
                <a href="#use-of-services" class="font-medium text-[16px] md:text-[18px] text-[var(--darkgray)] py-[10px] pl-[10px] duration-150 ease-out hover:bg-[var(--iconorange)] hover:text-[var(--gray100)] privacy-nav-links">3. Use of Services</a>
                <a href="#incident-reporting" class="font-medium text-[16px] md:text-[18px] text-[var(--darkgray)] py-[10px] pl-[10px] duration-150 ease-out hover:bg-[var(--iconorange)] hover:text-[var(--gray100)] privacy-nav-links">4. Incident Reporting</a>
                <a href="#data-privacy-and-security" class="font-medium text-[16px] md:text-[18px] text-[var(--darkgray)] py-[10px] pl-[10px] duration-150 ease-out hover:bg-[var(--iconorange)] hover:text-[var(--gray100)] privacy-nav-links">5. Data Privacy and Security</a>
                <a href="#users-conduct" class="font-medium text-[16px] md:text-[18px] text-[var(--darkgray)] py-[10px] pl-[10px] duration-150 ease-out hover:bg-[var(--iconorange)] hover:text-[var(--gray100)] privacy-nav-links">6. Users Conduct</a>
                <a href="#contact-information" class="font-medium text-[16px] md:text-[18px] text-[var(--darkgray)] py-[10px] pl-[10px] duration-150 ease-out hover:bg-[var(--iconorange)] hover:text-[var(--gray100)] privacy-nav-links">7. Contact Information</a>
            </div>
            </div>
            <div class="w-full max-w-[600px] h-fit flex flex-col gap-[10px] px-[40px] md:px-0">
                <section id="acceptance-of-terms" class="section">
                    <h6 class="font-medium md:text-[18px] text-[16px]">1. Acceptance of Terms</h6>
                    <p class="font-medium md:text-[18px] text-[16px] text-[var(--darkgray)] px-[15px]">By accessing and using the Barangay Integrated Record and Incident Management System (BIRIMS), you agree to comply with and be bound by these Terms and Conditions. If you do not agree, please discontinue using the system. The Barangay of San Bartolome, Quezon City reserves the right to modify or update these terms at any time without prior notice.</p>
                </section>
                <section id="user-accounts-and-registrations" class="section">
                    ...
                    <p class="font-medium md:text-[18px] text-[16px] text-[var(--darkgray)] px-[15px]">Users must register using accurate and complete information. Each account is personal and should not be shared with others. You are responsible for maintaining the confidentiality of your account credentials and all activities under your account. Any unauthorized access or misuse should be reported immediately to the barangay administration.</p>
                </section>
                <section id="use-of-services" class="section">
                    <h6 class="font-medium md:text-[18px] text-[16px]">3. Use of Services</h6>
                    <p class="font-medium md:text-[18px] text-[16px] text-[var(--darkgray)] px-[15px]">BIRIMS is designed to streamline barangay operations, including resident record management, document requests, and incident reporting. The system should only be used for official and lawful purposes. Misuse, tampering, or unauthorized access to data is strictly prohibited and may result in account suspension or legal action.</p>
                </section>
                <section id="incident-reporting" class="section">
                    <h6 class="font-medium md:text-[18px] text-[16px]">4. Incident Reporting</h6>
                    <p class="font-medium md:text-[18px] text-[16px] text-[var(--darkgray)] px-[15px]">Residents may submit incident reports such as complaints, accidents, or community concerns through the platform. All reports must be factual and submitted in good faith. False, misleading, or malicious reports will not be tolerated and may result in account restrictions or penalties under barangay ordinances.</p>
                </section>
                ...
                <section id="contact-information" class="section">
                   ...
                   <p class="font-medium md:text-[18px] text-[16px] text-[var(--darkgray)] px-[15px] leading-8 mt-[6px]">If you have questions or concerns about this Privacy Policy, you may contact:
                        ...
                        <a href="https://mail.google.com/mail/u/0/#inbox" target="_blank" class="flex gap-[10px] text-[16px] items-center text-[var(--darkgray)] font-medium stroke-[var(--darkgray)] duration-150 ease-out hover:text-[var(--orange)] hover:stroke-[var(--orange)] hover:underline">                
                            ...
                            <span class="text-[14px] md:text-[16px]">birim.sanbartolome@gmail.com</span>
                        </a>
