<section class="min-h-screen w-full flex flex-col items-center justify-center gap-[50px] py-8 pb-[80px]" id="cards-certificates">
    <div class="flex flex-col gap-2 items-center justify-center">
        <h1 style="font-family: 'IBM Plex Serif', serif;" class="font-medium text-[50px]">Lorem ipsum dolor sit amet</h1>
        <p class="font-medium text-[16px] text-[#A1A1AA] pl-[200px] pr-[200px] text-center">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut  labore et dolore magna aliqua. Ut enim ad minim veniam, quis </p>
    </div>
