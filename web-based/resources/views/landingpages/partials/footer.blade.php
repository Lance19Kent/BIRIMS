<footer class="h-[230px] flex justify-between items-center px-20">
    <div class="w-[450px]">
        ...
        <div class="flex stroke-[var(--darkgray)] items-center gap-[5px]">
            ...
            <a href="#" class="fill-black duration-150 ease-in hover:fill-[var(--orange)]">
                <svg width="29" height="25" viewBox="0 0 29 25" xmlns="http://www.w3.org/2000/svg">
                    <g clip-path="url(#clip0_46_815)">
                        <path d="M22.5516 0H26.8449L17.4651 10.5899L28.5 25H19.8595L13.0924 16.2601L5.34909 25H1.05284L11.0855 13.6731L0.5 0H9.35932L15.4764 7.98835L22.5516 0ZM21.0446 22.4614H23.4238L8.06673 2.40531H5.51391L21.0446 22.4614Z"/>
                    </g>
                    <defs>
