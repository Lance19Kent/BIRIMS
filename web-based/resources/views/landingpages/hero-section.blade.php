<section class="h-screen w-full flex justify-between items-center-safe px-30 pt-[60px]">
    <div class="w-[550px] flex flex-col gap-[20px]">
        ...
        <a href="#step-section" class="w-[190px] flex items-center pt-[10px] pb-[10px] pl-[20px] pr-[20px] text-white border border-[var(--gray)] fill-white bg-[#EA580C] rounded-[4px] justify-center gap-2 transition-[150_300_ease] hover:bg-[var(--gray)] hover:text-[#EA580C] hover:fill-[#EA580C] hover:border-[var(--orange)]">
