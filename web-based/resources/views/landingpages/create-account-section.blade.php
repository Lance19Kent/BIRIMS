<section class="w-full bg-white relative" style="height: calc(100vh - 80px);" id="create-account">
    ...
    <div class="w-full h-full flex flex-col gap-[20px] justify-center items-center px-[150px] text-center">
        ...
        <div class="flex gap-12 mt-4">
            <a href="#" class="text-[18px] text-white font-medium px-[20px] py-[10px] bg-[#EA580C] rounded-[4px] duration-150 ease-in border border-[#EA580C] hover:bg-white hover:text-[var(--orange)]">Create Account</a>
            <a href="#" class="text-[18px] text-[#EA580C] font-medium px-[20px] py-[10px] bg-white rounded-[4px] border duration-150 ease-in border-[#EA580C] hover:bg-[var(--orange)] hover:text-white">Sign in To Account</a>
        </div>
    </div>
