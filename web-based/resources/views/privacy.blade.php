...
<body class="w-full h-full">
    ...
    <main class="w-full min-h-screen flex-1 bg-[var(--gray)] relative md:pb-[40px] pb-[120px]">
        ...
        <div class="mt-[50px] flex flex-col md:flex-row justify-between gap-[50px] md:pr-[230px] md:pl-[250px]">
           <div class="w-full flex justify-center">
             <div class="w-full md:max-w-[410px] max-w-[300px] h-fit border border-[#71717A] flex flex-col rounded-[4px] sticky top-[150px]">
                <h1 style="font-family: 'IBM Plex Serif';" class="font-medium text-[16px] md:text-[18px] p-[10px]">On this page</h1>
                <a href="#introduction" class="font-medium text-[16px] md:text-[18px] text-[var(--darkgray)] py-[10px] pl-[10px] duration-150 ease-out hover:bg-[var(--iconorange)] hover:text-[var(--gray100)] privacy-nav-links active-privacy-nav">1. Introduction</a>
                <a href="#information-we-collect" class="privacy-nav-links font-medium text-[16px] md:text-[18px] text-[var(--darkgray)] py-[10px] pl-[10px]  duration-150 ease-out hover:bg-[var(--iconorange)] hover:text-[var(--gray100)]">2. Information We Collect</a>
                <a href="#use-of-services" class="privacy-nav-links font-medium text-[16px] md:text-[18px] text-[var(--darkgray)] py-[10px] pl-[10px] duration-150 ease-out hover:bg-[var(--iconorange)] hover:text-[var(--gray100)]">3. Use of Services</a>
                <a href="#data-privacy-and-protection" class="privacy-nav-links font-medium text-[16px] md:text-[18px] text-[var(--darkgray)] py-[10px] pl-[10px] duration-150 ease-out hover:bg-[var(--iconorange)] hover:text-[var(--gray100)]">4. Data Privacy and Protection</a>
                <a href="#data-sharing-and-disclosure" class="privacy-nav-links font-medium text-[16px] md:text-[18px] text-[var(--darkgray)] py-[10px] pl-[10px] duration-150 ease-out hover:bg-[var(--iconorange)] hover:text-[var(--gray100)]">5. Data Sharing and Disclosure</a>
                <a href="#user-rights" class="privacy-nav-links font-medium text-[16px] md:text-[18px] text-[var(--darkgray)] py-[10px] pl-[10px] duration-150 ease-out hover:bg-[var(--iconorange)] hover:text-[var(--gray100)]">6. User Rights</a>
                <a href="#updates-to-this-policy" class="privacy-nav-links font-medium text-[16px] md:text-[18px] text-[var(--darkgray)] py-[10px] pl-[10px] duration-150 ease-out hover:bg-[var(--iconorange)] hover:text-[var(--gray100)]">7. Updates to This Policy</a>
                <a href="#contact-us" class="privacy-nav-links font-medium text-[16px] md:text-[18px] text-[var(--darkgray)] py-[10px] pl-[10px] duration-150 ease-out hover:bg-[var(--iconorange)] hover:text-[var(--gray100)]">8. Contact Us</a>
