...
<body class="h-screen max-h-screen w-full relative">
    ...
    <main class="flex-1 w-full relative z-30 md:pl-5 md:flex-row flex-col flex items-center md:gap-0 gap-[30px] md:justify-between" style="height: calc(100vh - 60px); ">
        ...
        <div class="w-full flex justify-center">
            <form class="w-full max-w-[400px] h-full justify-center flex flex-col gap-[30px] md:pb-20 pb-[50px] px-[30px] md:px-0" method="POST" action="{{ route('login.post') }}">
            @csrf
                ...
                <div class="flex flex-col gap-[25px]">
                    <span class="flex flex-col relative leading-3">                
                        <label class="font-semibold md:text-[13px] text-[12px]">Email</label>
                            <input type="text" name="email" placeholder="example@chakraui" class="peer md:text-[13px] text-[12px] w-full duration-150 ease-out h-[45px] border-b focus:outline-none focus:border-b focus:border-[var(--orange)] placeholder:pl-[25px] placeholder-shown:placeholder:opacity-100 focus:placeholder-shown:placeholder:opacity-0 placeholder:text-[var(--darkgray)] placeholder:md:text-[14px] placeholder:text-[12px]">
