...
<body class="w-full h-full">
    ...
    <main class="w-full min-h-screen flex-1 bg-[var(--gray)] relative pb-[40px]">
        ...
        <div class="flex justify-center pt-[50px] items-center pb-[20px]">
            <div class="w-[500px] h-[300px] flex flex-col gap-[30px] pl-[50px] pr-[60px]">
                <div class="flex gap-[20px]">
                    ...
                    <a href="https://mail.google.com/mail/u/0/#inbox" class="text-[16px] duration-150 ease-out hover:underline hover:text-[var(--orange)]" target="_blank">birim.sanbartolome@gmail.com</a>
                </div>
                <div class="flex gap-[20px]">
                    ...
                    <a href="https://maps.app.goo.gl/US9Wyf2JoGo8bBey5" class="text-[16px] duration-150 ease-out hover:underline hover:text-[var(--orange)]" target="_blank">P22M+7WC, Quirino Hwy, Novaliches, Quezon City, Metro Manila, Philippines</a>
                </div>
                <div class="flex gap-[20px]">
                    ...
                    <a href="https://web.facebook.com/brgysanbartolome2014" class="text-[16px] duration-150 ease-out hover:underline hover:text-[var(--orange)]" target="_blank">www.facebook.com/brgysanbartolome2014</a>
                </div>
                <div class="flex gap-[20px]">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="var(--iconorange)" class="size-6">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 0 0 2.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 0 1-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 0 0-1.091-.852H4.5A2.25 2.25 0 0 0 2.25 4.5v2.25Z" />
                    </svg>
                    <a href="#" class="text-[16px] duration-150 ease-out hover:underline hover:text-[var(--orange)]">+28 277 6775</a>
                </div>
            </div>
            <div class="w-[500px]  pr-[55px]">
                <form class="flex flex-col gap-[25px]">
                    ...
                    <button class="h-[45px] w-full bg-[var(--orange)] text-white rounded-[4px] border border-[var(--orange)] cursor-pointer duration-150 ease-in hover:bg-[var(--lightgray)] hover:text-[var(--orange)]">Submit</button>
                </form>
            </div>
        </div>
    </main>
